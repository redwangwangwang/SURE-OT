...
class CheXbert(nn.Module):
    def __init__(self, checkpoint_path, device, p=0.1):
        ...
        with torch.no_grad():
            ...
            # new_state_dict["module.bert.embeddings.position_ids"] = torch.arange(config.max_position_embeddings).expand((1, -1))
            ...
            # 打印 new_state_dict 中的键
            print("Keys in the new_state_dict:")
