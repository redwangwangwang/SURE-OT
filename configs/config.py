...
parser.add_argument('--annotation', type=str, default="./data/iu_xray/data.json", help="annotation file of the dataset")
...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='./data/swin-base-patch4-window7-224', type=str, help="vision model to use")
parser.add_argument('--llama_model', default='./data/Llama-2-7b-chat-hf/', type=str, help="LLM model to use")
